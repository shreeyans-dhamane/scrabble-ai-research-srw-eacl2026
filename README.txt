This repository contains the official Python implementation for the paper: "Optimizing Heuristic Decision-Making in a Stochastic Tile-Based Game Using a Tuned Risk-Tolerance Hyperparameter."
